...
const credentialPendingView = ({ credentialData, selectedRecord, handleRecordClick, handleBackButtonClick }) => {
 return(
...
credentialPendingView.propTypes = {
...
export default credentialPendingView;
