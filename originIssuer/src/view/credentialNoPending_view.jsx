...
const credentialNoPendingView = ({ credentialData, selectedRecord, handleRecordClick, handleBackButtonClick }) => {
 return(
...
credentialNoPendingView.propTypes = {
...
export default credentialNoPendingView;
